...
\begin{figure}
\centering
\subfigure[t1]{\includegraphics[width=0.7\textwidth]{./Figure-Stress-0100-mode-I.png}}
\subfigure[t2]{\includegraphics[width=0.7\textwidth]{./Figure-Stress-0250-mode-I.png}}
\subfigure[t3]{\includegraphics[width=0.7\textwidth]{./Figure-Stress-0398-mode-I.png}}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{./Figure-Drop-weight}
  \caption{Geometry and boundary condition of the drop-weight impact test.}
