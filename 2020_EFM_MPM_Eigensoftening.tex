...
\cite{HA_2011,RABCZUK_2017} among others. \\
 ...
 \DM{ Miguel...esto artículos se pueden citar pra enteder la evolución de la progración de la fractura. Hay estados del arte muy buenos entre ellos.  X-FEM with Level set
T. Nagashima, M. Sawada Development of a damage propagation analysis system based on level set XFEM using the cohesive zone model Comput Struct, 174 (2016), pp. 42-53
J. Huang An efficient morphology generation and level set representation of cementitious microstructures with arbitrarily shaped aggregates and cracks via extended finite elements
Comput Struct, 206 (2018), pp. 122-144
Y. Abdelaziz, A. Hamouine A survey of the extended finite element Comput Struct, 86 (11) (2008), pp. 1141-1151}
...
\DM{Cometario general: Pienso que hay que estructurar un poco la conclusión. No agregar tantas citas. Acá estás concluyendo tu trabajo. Iría de lo general a lo particular. Pondría claramente en cada parrafo cual es el aporte. Con tantas citas no queda claro que hiciste vos y que los otros. Las citas estarán puestas cuando vos comenzaste a hablar de lo que hiciete en el cuerpo del documento. Acá las citas minimas y tus aportes.
Imagino un primer parrafo asi diciendo cuales son las limitaciones ...propuesta modificable...:}
...
stress and strain peaks in the fracture mechanism of quasi-brittle materials and the stress oscillations observed with conventional \acrshort{mpm}/\acrshort{gimp} are faced.  }
