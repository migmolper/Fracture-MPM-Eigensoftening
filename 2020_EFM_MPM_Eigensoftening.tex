...
algorithms based on the eigendeformation concept are presented in \ref{sec:2.3}.
...
method where moving material points, henceforth in this research, particles will carry on
all the physical information of the local state ($\sigma_p,
\varepsilon_p$) and a set of fixed background nodes will be introduced to compute the balance of momentum equation. Since the \acrshort{mpm} 
...
\end{equation}
\PNA{EXPLICAR NOTACION, CUIDADO CON EL GAMMA} This way of computing the nodal predictor is numerically stable
