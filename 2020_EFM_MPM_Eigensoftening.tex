...
% The velocities of the top boundary particles are vx =
% 0,vy = − 2 mm/s, whereas the velocities of the bottom boundary
% particles are as vy = 0.

%     \gls{heps}
%     \gls{Ceps}

% As Johnstone rocks are classified as soft rocks with a relatively
% small elastic Young's modulus. Ramp loading is applied to alleviate the dynamic
