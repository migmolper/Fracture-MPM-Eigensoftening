...
\textcolor{red}{artifices}  have been proposed with the aim of reproducing such a
...
\textcolor{blue}{the explicit predictor-corrector time integration scheme proposed by Molinos~\etal~\cite{Molinos2020} is adopted}. The
...
velocity predictor \textcolor{red}{$ \vec{v}_{I}^{pred}$} is computed through
...
patterns such as the ones obtained with fiber \textcolor{red}{reinforced} concrete (FRC),
\cite{Navas_2018_ES}.\\
