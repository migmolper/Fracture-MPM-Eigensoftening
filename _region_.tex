...
linear-elastic Hookean material, where Young's modulus $E = 1.06$, the
Poisson's ratio $\mu = 0.333$, and critical energy-release rate $G_c =
0.0001$.
...
\begin{figure}
\centering
\subfigure[t = 25]{\includegraphics[width=0.7\textwidth]{./Figure-Stress-0100-mode-I.png}}
\subfigure[t = 60]{\includegraphics[width=0.7\textwidth]{./Figure-Stress-0250-mode-I.png}}
\subfigure[t = 100]{\includegraphics[width=0.7\textwidth]{./Figure-Stress-0398-mode-I.png}}
...
with linear interpolation. Therefore this section is devoted
...
\end{document}
\message{ !name(2020_EFM_MPM_Eigensoftening.tex) !offset(-902) }
