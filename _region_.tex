...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{Figures/Mode_I}
...
\begin{figure}
\centering
\subfigure[t1]{\includegraphics[width=0.7\textwidth]{./Figures/Edge_cracked_square_panel_in_mode_I_Stress_0100.png}}
\subfigure[t2]{\includegraphics[width=0.7\textwidth]{./Figures/Edge_cracked_square_panel_in_mode_I_Stress_0250.png}}
\subfigure[t3]{\includegraphics[width=0.7\textwidth]{./Figures/Edge_cracked_square_panel_in_mode_I_Stress_0398.png}}
\caption{Legos.}
\label{fig:Stress-cracked-panel-mode-I}
\end{figure}

Edge_cracked_square_panel_in_mode_I_Stress_0250.png
Edge_cracked_square_panel_in_mode_I_Stress_0398.png
...
\end{document}
\message{ !name(2020_EFM_MPM_Eigensoftening.tex) !offset(-867) }
