...
extracted, see Figure \ref{fig:Stress-vs-damage-impact-test}. Compared
with results obtained by \cite{Navas_2017_ES}, stress evolution
...
\end{document}
\message{ !name(2020_EFM_MPM_Eigensoftening.tex) !offset(-1019) }
