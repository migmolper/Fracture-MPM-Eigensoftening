...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{Particle-failed}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{Damage}
  \caption{Scheme of a linear cohesive law, where the shaded area is
    $G_f$, $f_t$ is the tensile strength, and $w_c$ is the critical
    opening displacement.}
...
\ref{sec:edge-cracked-square-I}. Where both interpolation techniques
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{Mode_I}
...
linear-elastic Hookean material, where Young's modulus $E = 1.06$, the Poisson's ratio
$\mu = 0.333$, and critical energy-release rate $G_c = 0.0001$. 

Figure \ref{fig:Reactions-cracked-panel-mode-I} clearly shows the
presence of wiggles in the loading and also in the unloading regions
of the curve when a linear interpolation technique is employed. In
contrast with it \acrshort{lme} simulation does not exhibit this
accuracy and remains rectilinear during loading and unloading. An
important consideration regarding the presence of oscillations once
both parts of the panel are separated. Is that they should not be
attributed to the eigenerosion algorithm since the fracture process is
over. They are due to the dynamic nature of the simulation.  

\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{Reactions_displacements_square_panel_mode_I}
...
\begin{figure}
\centering
\subfigure[t1]{\includegraphics[width=0.7\textwidth]{./Edge_cracked_square_panel_in_mode_I_Stress_0100.png}}
\subfigure[t2]{\includegraphics[width=0.7\textwidth]{./Edge_cracked_square_panel_in_mode_I_Stress_0250.png}}
\subfigure[t3]{\includegraphics[width=0.7\textwidth]{./Edge_cracked_square_panel_in_mode_I_Stress_0398.png}}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{./Drop_weight}
  \caption{Geometry and boundary condition of the drop-weight impact test.}
...
\end{document}
\message{ !name(2020_EFM_MPM_Eigensoftening.tex) !offset(-868) }
