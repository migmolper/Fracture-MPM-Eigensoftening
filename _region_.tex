...
\label{sec:1}
Presence of cracks are a violation of the continuity requirement of
the finite element method (FEM). To overcome it, numerous of numerical
...
techniques. Some examples of it are the material
point method (MPM) \cite{Schreyer_2002,Chen_2002,Nairn_2003,Zhenmao_2005}, the
element-free Galerkin method (EFGM) \cite{BELYTSCHKO_1995,BELYTSCHKO_2000,Zhuang_2012,Muthu_2013},
...
softened (or failed) volume. Due to the similarities between the OTM, 
where this procedure was developed, and the MPM, we propose 
...
employing the MPM and introducing both eigenerosion
 and eigensoftening \cite{Navas_2017_ES,Navas_2018_ES} and the concept of the
...
\end{document}
\message{ !name(2020_EFM_MPM_Eigensoftening.tex) !offset(-676) }
