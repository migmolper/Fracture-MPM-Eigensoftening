...
fracture pattern is a vertical straight line when $\alpha$ =
0$^{\circ}$  (pure mode I). When $\alpha$ > 0$^{\circ}$, the sample is
...
\message{ !name(2020_EFM_MPM_Eigensoftening.tex) !offset(-1280) }
